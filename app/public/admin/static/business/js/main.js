...
/*优惠券-删除*/
function coupon_del(obj, id, model) {
  ...
  layer.confirm(
    ...
    function() {
      ...
      $(obj)
        .parents("tr")
        .find(".td-status")
        .html('<span class="label label-success radius">已发布</span>');
      $(obj).remove();
    ...
    function() {
      ...
      $(obj)
        .parents("tr")
        .find(".td-status")
        .html('<span class="label label-danger radius">未通过</span>');
      $(obj).remove();
...
function article_stop(obj, id) {
  layer.confirm("确认要下架吗？", function(index) {
    $(obj)
      ...
      .find(".td-manage")
      .prepend(
        '<a style="text-decoration:none" onClick="article_start(this,id)" href="javascript:;" title="发布">发布</a>'
      );
    $(obj)
      .parents("tr")
      .find(".td-status")
      .html('<span class="label label-defaunt radius">已下架</span>');
    $(obj).remove();
...
function article_start(obj, id) {
  layer.confirm("确认要发布吗？", function(index) {
    $(obj)
      ...
      .find(".td-manage")
      .prepend(
        '<a style="text-decoration:none" onClick="article_stop(this,id)" href="javascript:;" title="下架">下架</a>'
      );
    $(obj)
      .parents("tr")
      .find(".td-status")
...
function article_shenqing(obj, id) {
  $(obj)
    .parents("tr")
    .find(".td-status")
    .html('<span class="label label-default radius">待审核</span>');
  $(obj)
    .parents("tr")
    .find(".td-manage")
    .html("");
...
function picture_stop(obj, id) {
  layer.confirm("确认要下架吗？", function(index) {
    $(obj)
      ...
      .find(".td-manage")
      .prepend(
        '<a style="text-decoration:none" onClick="picture_start(this,id)" href="javascript:;" title="发布">发布</a>'
      );
    $(obj)
      .parents("tr")
      .find(".td-status")
...
function picture_start(obj, id) {
  layer.confirm("确认要发布吗？", function(index) {
    $(obj)
      ...
      .find(".td-manage")
      .prepend(
        '<a style="text-decoration:none" onClick="picture_stop(this,id)" href="javascript:;" title="下架">下架</a>'
      );
    $(obj)
      .parents("tr")
      .find(".td-status")
...
function product_stop(obj, id) {
  layer.confirm("确认要下架吗？", function(index) {
    $(obj)
      ...
      .find(".td-manage")
      .prepend(
        '<a style="text-decoration:none" onClick="product_start(this,id)" href="javascript:;" title="发布">发布</a>'
      );
    $(obj)
      .parents("tr")
      .find(".td-status")
...
function product_start(obj, id) {
  layer.confirm("确认要发布吗？", function(index) {
    $(obj)
      ...
      .find(".td-manage")
      .prepend(
        '<a style="text-decoration:none" onClick="product_stop(this,id)" href="javascript:;" title="下架">下架</a>'
      );
    $(obj)
      .parents("tr")
      .find(".td-status")
